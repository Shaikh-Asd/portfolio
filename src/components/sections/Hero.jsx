    ...
    <section className="relative flex min-h-[100dvh] items-center overflow-hidden pt-20 pb-12 sm:pt-24 sm:pb-16">
      ...
      <div className="container-main relative z-10 w-full">
        ...
        >
          {/* <m.div
            variants={fadeUp}
            className="mb-5 inline-flex max-w-full items-center gap-2 section-badge rounded-full px-3 py-1.5 text-xs sm:mb-6 sm:px-4 sm:text-sm"
          >
          ...
          <h1 className="text-[1.75rem] leading-[1.15] font-bold tracking-tight text-foreground sm:text-5xl md:text-6xl lg:text-7xl">
          ...
          <m.p
            variants={fadeUp}
            className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-muted sm:mt-6 sm:text-lg md:text-xl"
          >
          ...
          <m.div
            variants={fadeUp}
            className="mt-8 flex flex-row flex-wrap items-center justify-center gap-3 sm:mt-10 sm:gap-4"
          >
        ...
        <m.div
          ...
          initial="hidden"
          animate="visible"
          className="mx-auto mt-10 grid max-w-3xl grid-cols-2 gap-2.5 sm:mt-16 sm:gap-4 md:grid-cols-4"
        >
          {heroStats.map((stat) => {
